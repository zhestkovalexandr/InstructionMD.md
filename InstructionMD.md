...
1. Делаем fork чужего репозитория

2. Делаем git clone для нашей версии чужего репозитория.

3. Создаем новую ветку.

4. Производим все изменения только в новой ветке.

5. Отправляем сохраненые изменения в свой аккаунт (push).

6. В окне на Git Hub появится возможноять Pull Request. 